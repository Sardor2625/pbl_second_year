   ...
   <div class="row">             
    ...
    <div class="col-sm-6">
    	       <div style="margin-bottom:17px;">
 				...
 				<div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control  <?= (form_error('e_physicalexam') == "" ? '':'is-invalid') ?>" type="text" name="e_physicalexam" value="<?php echo $get_findings_view->f_physicalexam; ?>" placeholder="Jismoniy holatini kiriting">           
        ...
        <div class="text-danger text-center"><?php echo form_error('e_physicalexam'); ?></div>
               ...
               <div style="margin-bottom:17px;">
                <div class="row no-gutters">
 				...
 				<div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control  <?= (form_error('e_diagnosis') == "" ? '':'is-invalid') ?>" type="text" name="e_diagnosis" value="<?php echo $get_findings_view->f_diagnosis; ?>" placeholder='Diagnozni kiriting'>
        ...
        <div class="text-danger text-center"><?php echo form_error('e_diagnosis'); ?></div>
 			  ...
 			  <div style="margin-bottom:17px;">
 				...
 				<div class="h5 mb-1 font-weight-bold text-gray-800"><input class="form-control  <?= (form_error('e_medical_treatment') == "" ? '':'is-invalid') ?>" type="text" name="e_medical_treatment" value="<?php echo $get_findings_view->f_medication; ?>" placeholder='Dori-darmonlarni kiriting'>
