     ...
     <div class="container-fluid">
         ...
         <h1 class="h3 mb-2 text-gray-800 text-center">Bemor yozuvini qo'shing</h1>

              <hr>
                 <div class="row "><!-- ROW 1 -->
                   <div class="col-sm-4"></div>
                   <div class="col-sm-4">
                     <h6 class="text-center"><b>Toshken Shaxar klinikasi</b></h6>
                     <h5 class="text-center"><b>Bemor yozuvlari</b></h5>
                   </div>
                   <div class="col-sm-4"></div>
                 </div>
               ...
               <?php echo form_open('admissioncontrol/opd_process', $attributes); ?>
                 ...
                 <div class="col-sm-12 "><!-- first column -->
                  <div class="row">
                   ...
                   <input type="text"  class="form-control  <?= (form_error('lname') == "" ? '':'is-invalid') ?>"  name="lname" placeholder="Familiya" value="<?php echo set_value('lname') ?>">
                  <div class="text-danger text-center"><?php echo form_error('lname'); ?></div>
                     </div>
                     <div class="col-sm-4">
                       <?php echo form_label('Firstname'); ?>
                           <input type="text" style="margin-left: 4px;"  class="form-control  <?= (form_error('fname') == "" ? '':'is-invalid') ?>"  name="fname" placeholder="Ism" value="<?php echo set_value('fname') ?>">
                  <div class="text-danger text-center"><?php echo form_error('fname'); ?></div>
                     </div>
                     <div class="col-sm-3">
                      <?php echo form_label('MiddleInitial'); ?>
                       <input type="text" style="margin-left: 2px;" class="form-control  <?= (form_error('middlen') == "" ? '':'is-invalid') ?>"  name="middlen" placeholder="Otasining ismi" value="<?php echo set_value('middlen') ?>">
                  ...
                  <div class="row">
                    <div style="margin-left: 4px;" class="col-sm-11">
                      <?php echo form_label('Address'); ?>
                                <input type="text" style="margin-left: 7px;" class="form-control  <?= (form_error('address') == "" ? '':'is-invalid') ?>"  name="address" placeholder="Doimiy yashash joyi" value="<?php echo set_value('address') ?>">
                   ...
                   <div class="row">
                     <div style="margin-left: 4px;" class="col-sm-2">
                       <?php echo form_label('Age'); ?>
                                <input type="text" class="form-control  <?= (form_error('age') == "" ? '':'is-invalid') ?>"  name="age" placeholder="Yosh" value="<?php echo set_value('age') ?>">
                    ...
                    <div style="margin-left: 4px;" class="col-xs-3">
                     ...
                     <div style="margin-left: 4px;" class="col-sm-3">
                       <?php echo form_label('Birthplace'); ?>
                                <input type="text" class="form-control  <?= (form_error('birthplace') == "" ? '':'is-invalid') ?>" placeholder="Tug'ilgan joyi"  name="birthplace" value="<?php echo set_value('birthplace') ?>">
                   ...
                   <div class="text-danger text-center"><?php echo form_error('gen'); ?></div>
                     ...
                     <div style="margin-left: 30px;" class="col-xs-3">
                        <?php echo form_label('Mobile/Tel No.'); ?>
                                <input type="number" class="form-control  <?= (form_error('number') == "" ? '':'is-invalid') ?>" placeholder="Mobile/Tel "  name="number" value="<?php echo set_value('number') ?>">
                    ...
                    <div style="margin-left: 20px;" class="col-xs-3">
                        <?php echo form_label('Religion'); ?>
                                <input type="text" class="form-control  <?= (form_error('religion') == "" ? '':'is-invalid') ?>" placeholder="Dini"  name="religion" value="<?php echo set_value('religion') ?>">
                     <div class="text-danger text-center"><?php echo form_error('religion'); ?></div> 
                   </div>

                    <div style="margin-left: 20px;" class="col-xs-3">
                      <?php echo form_label('Occupation'); ?>
                                <input type="text" class="form-control <?= (form_error('occup') == "" ? '':'is-invalid') ?>" placeholder="Kasbi"  name="occup" value="<?php echo set_value('occup') ?>">
