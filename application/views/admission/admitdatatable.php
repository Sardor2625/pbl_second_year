          ...
          <div class="card shadow mb-4">
            ...
            <!-- Page Heading -->
          <h5 class="mb-2 text-gray-800">Bemor yozuvlari jadvali<a style="margin-left: 700px;" href="<?php echo base_url(); ?>admissioncontrol/opd_form" >
           ...
           <?php endif; ?>
              ...
              <div class="table">
                <table class="table table-bordered " id="dataTable" width="100%" cellspacing="0">
                  ...
                  <thead>
                    <tr>
                      <th class="text-center">Ish raqami.</th>
                      <th class="text-center">Familiya</th>
                      <th class="text-center">Ism</th>
                      <th class="text-center">Otasini ismi</th>
                      <th class="text-center">jinsi</th>
                      <th class="text-center">Yoshi</th>
                      <th class="text-center">Aloqa raqami</th>
                      <th class="text-center">Qo'shilgan sana</th>
                      <th class="text-center">faoligi</th>
                    </tr>
                  </thead>
