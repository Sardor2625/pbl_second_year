            ...
            <div  id="findings" class="col-xl-8 col-lg-4">
              <div class="card shadow mb-4">
               ...
               <?php foreach($get_findings_data as $findings): ?>
                ...
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-success">Qabul <?php echo "<a style='margin-left: 550px; text-decoration:none;' class='text-secondary' href='". base_url() ."admissioncontrol/patientdataview/". $get_data->pr_id ."#admission'>" ?> <i class="fa 
