            ...
            <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-success">Tafsilotlar <?php echo "<a style='margin-left: 225px; text-decoration:none;' class='text-secondary' href='". base_url() ."admissioncontrol/patient_edit_option/". $get_findings_view->pr_id ."'>" ?> 
            ...
            <div  id="findings" class="col-xl-8 col-lg-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">OPD natijalari <?php echo "<a style='margin-left: 530px; text-decoration:none;' class='text-secondary' href='". base_url() ."admissioncontrol/findingsview/". $get_findings_view->findings_id ."#findings'>" ?> <i class="fa 
