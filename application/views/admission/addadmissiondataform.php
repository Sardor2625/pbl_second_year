     ...
     <div class="col-sm-6">
           ...
           <div style="margin-bottom:17px;">
                <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Familiya</div>   
                </div>
        ...
        <div class="text-danger text-center"><?php echo form_error('e_patientfname'); ?></div>
            ...
            <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Otasini ismi</div>   
                </div>
