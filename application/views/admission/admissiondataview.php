...
<div class="row"><!-- Begin Row -->
  ...
  <!-- First Column -->
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_admission_view->pr_age; ?></div>
              ...
              <div style="margin-bottom:17px;">
        <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Tug'ilgan kun</div> 
                </div>
            ...
            <div  id="admission" class="col-xl-8 col-lg-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">Qabul <?php echo "<a style='margin-left: 400px; text-decoration:none;' class='text-secondary' href='". base_url() ."admissioncontrol/patientdataview/". $get_admission_view->pr_id ."#findings'>" ?> <i class="fa 
 ...
 <a style='margin-left: 15px; margin-right: 10px;' class="btn_print text-secondary"><i class="fa 
   ...
   <div id="printablearea"><!-- Printable Area -->
       ...
       <?php if($this->session->flashdata('edit_admit_success')): ?>  
           ...
           <?php endif; ?>
                  ...
                  <div class="row "><!-- ROW 1 -->
                   <div class="col-sm-4"></div>
                     ...
                     <h5 class="text-center"><b>KLINIK ISHLAB CHIQISH</b></h5>
        ...
        <div class="row no-gutters">
              <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Ish raqami.</div>
                </div>
        ...
        <div class=" no-gutters ">
           ...
           <div class="col-sm-6">
                 <div style="margin-bottom:17px;">
        <div class=" no-gutters">
              <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Bemor ismi</div>
                </div>
             <div class="h4 mb-1 font-weight-bold text-gray-800">
    ...
    <div style="margin-left: 5px;" class="row">
          ...
          <div class="col-sm-6">
                 <div style="margin-bottom:17px;">
        <div class=" no-gutters">
              <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">kim tomonidan qabul qilingan</div>
                </div>
             <div class="h4 mb-1 font-weight-bold text-gray-800">
