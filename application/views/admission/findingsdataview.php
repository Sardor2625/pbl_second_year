...
<div class="row"><!-- Begin Row -->
  ...
  <!-- First Column -->
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_findings_view->pr_occup; ?></div>
         ...
         <div style="margin-bottom:18px;">
        <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Maslahatlashgan sana</div>
                </div>
            ...
            <div  id="findings" class="col-xl-8 col-lg-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">OPD natijalari <?php echo "<a style='margin-left: 350px; 
          ...
          <?php echo "<div style='#1cc88a' class='alert alert-success alert-dismissible text-center'>
           ...
           <?php endif; ?>
                  ...
                  <div class="row "><!-- ROW 1 -->
                   ...
                   <div class="col-sm-8">
                     <h5 class="text-center"><b>Bemorlarning natijalari</b></h5>
                     <hr>
                   </div>
                   <div class="col-sm-2"></div>
                 </div>
