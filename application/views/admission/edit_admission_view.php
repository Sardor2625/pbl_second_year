...
<div class="row"><!-- Begin Row -->
  ...
  <!-- First Column -->
            <div class="col-lg-4">
              ...
              <div class="card shadow mb-4">
                <div class="card-header py-3">
                  <h6 class="m-0 font-weight-bold text-success">Tafsilotlar <?php echo "<a style='margin-left: 225px; text-decoration:none;' class='text-secondary' href='". base_url() ."admissioncontrol/patient_edit_option/". $get_data_admission->pr_id ."'>" ?> 
        ...
        <div class="h5 mb-1 font-weight-bold text-gray-800"><?php echo $get_data_admission->pr_addrs; ?></div>
               ...
               <div style="margin-bottom:17px;">
                <div class="row no-gutters">
                 <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Yoshi</div>   
                </div>
            ...
            <div  id="admission" class="col-xl-8 col-lg-4">
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">Qabul <?php echo "<a style='margin-left: 470px; text-decoration:none;' class='text-secondary' href='". base_url() ."admissioncontrol/admissionview/". $get_data_admission->admission_id ."#admission'>" ?> <i class="fa 
                   fa-arrow-left"></i></a> 
                </div>
                <!-- Card Body -->
                <div class="card-body">
