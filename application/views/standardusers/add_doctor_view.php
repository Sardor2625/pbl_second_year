       <!-- DataTales Example -->
         ...
         <h5 class="mb-2 text-gray-800">Shifokor qo`shish </h5>
        ...
        <?php if($this->session->flashdata('add_doctor')): ?>  
          ...
          <div  id="addusertable" class="card shadow mb-4">
            ...
            <!-- Page Heading -->
          <h5 class="mb-2 text-gray-800">Shifokorlar </h5>  
...
function doconfirm()
{
    job = confirm("Haqiqatan ham shifokorni o'chirib tashlamoqchimisiz?");
    if (job != true)
    {
        return false;
    }
