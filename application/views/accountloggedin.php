        ...
        <?php if($this->session->flashdata('login_failed')): ?>
          ...
          <?php echo "<div class='alert alert-danger alert-dismissible text-center'>
           ...
           <?php endif; ?>
              ...
              <div class="text-center">
                <a style="color: black; text-decoration: none" class="small" href="<?php echo base_url(); ?>standardusercontrol/standarduserview">Standart foydalanuvchi hisobiga o'tish</a>
              </div>
