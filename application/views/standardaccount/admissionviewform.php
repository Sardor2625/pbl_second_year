 ...
 <?php $attributes = array('id' => 'edit_admission_form', 'class' => 'form-horizontal user'); ?>
        ...
        <div class="row no-gutters">
          ...
          <input class="form-control  <?= (form_error('u_admitted') == "" ? '':'is-invalid') ?>" type="text" name="u_admitted"  placeholder="Kirish Qabul qilingan" value="<?php echo $get_patient_data->a_admittedby; ?><?php echo set_value('u_admitted') ?>">     
        ...
        <div class="row no-gutters">
         ...
         <div class="col-sm-4">
               <div  style="margin-bottom:17px;">
        <div class="row no-gutters">
           <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">ga yuboring</div>
                </div>
