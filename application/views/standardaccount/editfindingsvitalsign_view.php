            ...
            <div  id="findings" class="col-sm-5 ">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">Hayotiy belgilar <?php echo "<a style='margin-left: 255px; text-decoration:none;' class='text-secondary' href='". base_url() ."standardusercontrol/findings_view/". $get_patient_data->a_id ."'>" ?> 
...
<!-- ///// -->
            <div  id="findings" class="col-sm-7 ">
                ...
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success"> Topilmalar <?php echo "<a style='margin-left: 375px; text-decoration:none;' class='text-secondary' href='". base_url() ."standardusercontrol/update_findings/". $get_patient_data->a_id ."'>" ?> 
