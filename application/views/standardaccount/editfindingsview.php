        ...
        <div class="row no-gutters">
          ...
          <div class="row"><!-- Begin Row -->
           <div class="col-sm-4">
            ...
            <div style="margin-bottom:17px;">
        <div class="row no-gutters">
              <div class="text-xs font-weight-bold text-secondary text-uppercase mb-1">Harorati</div>
                </div>
             <div class="h5 mb-1 font-weight-bold text-gray-800">
...
<!-- ///// -->
            <div  id="findings" class="col-sm-7">
                ...
                <!-- Card Header - Dropdown -->
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">Topilmalar <?php echo "<a style='margin-left: 350px; text-decoration:none;' class='text-secondary' href='". base_url() ."standardusercontrol/findings_view/". $get_patient_data->a_id ."'>" ?> 
