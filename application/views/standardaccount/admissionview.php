  ...
  <div class="align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800 text-center">Qabul</h1>
          </div>
            ...
            <div  id="admission" class="col-sm-12 ">
              ...
              <div class="card shadow mb-4">
                ...
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                   <h6 class="m-0 font-weight-bold text-success">Qabul tafsilotlari<?php echo "<a style='margin-left: 755px; text-decoration:none;' class='text-secondary' href='". base_url() ."standardusercontrol/update_admission/". $get_patient_data->a_id ."'>" ?> 
