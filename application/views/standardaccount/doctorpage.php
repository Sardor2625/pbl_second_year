 ...
 <!-- Divider -->
      ...
      <li class="nav-item active">
        ...
        <a class="nav-link collapsed " href="<?php echo base_url(); ?>standardusercontrol/admissionview">
          <i class="fas fa-fw fa-table "></i>
          <span>Qabul qilish jadvali</span></a>
      </li>
  ...
  <div class="modal fade" id="logoutModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-body">Agar joriyingizni tugatishga tayyor bo'lsangiz, quyida "Chiqish" ni tanlang session.</div>
        <div class="modal-footer">
          <button class="btn btn-secondary" type="button" data-dismiss="modal">Cancel</button>
          <a class="btn btn-success" href="<?php echo base_url(); ?>standardusercontrol/logout">Chiqish</a>
        </div>
      </div>
    </div>
  </div>
