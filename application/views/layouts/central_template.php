  ...
  <div id="wrapper">
    ...
    <ul class=" navbar-nav bg-gradient-success sidenav sidebar sidebar-dark accordion " id="accordionSidebar">
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center"  href="#">
        ...
        <div class="sidebar-brand-text mx-3">Bemor yozuvlari</div>
      </a>
 ...
 <!-- Divider -->
       ...
       sa loob ng file name na config.php sa bandang baba makikita yan
        ...
        <?php echo base_url(); ?>
         ...
         -->
          ...
          <span>Bemor yozuvlari Table</span></a>
      </li>
      ...
      <!-- <li class="nav-item active"> -->
        ...
        <!-- <a class="nav-link collapsed " href="<?php echo base_url(); ?>multiplerecordcontrol/multiplerecordview">
          ...
          <span>Yozuvlarni qo'shish</span></a>
      </li> -->
      ...
      <li class="nav-item active">
        ...
        <a class="nav-link collapsed " href="<?php echo base_url(); ?>addusercontrol/adduserview">
          ...
          <span>Foydalanuvchilarni qo'shish</span></a>
      </li>
      ...
      <li class="nav-item active">
        ...
        <a class="nav-link collapsed " href="<?php echo base_url(); ?>logscontrol/logsview">
          ...
          <span>Foydalanuvchi jurnallari</span></a>
      </li>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>Mualliflik huquqi &copy; Bemor Record Himoyalangan </span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title" id="exampleModalLabel">Ketishga tayyormisiz?</h5>
        ...
        <div class="modal-footer">
          ...
          <a class="btn btn-success" href="<?php echo base_url(); ?>usercontrol/logout">chiqish</a>
        </div>
      </div>
    </div>
  </div>
