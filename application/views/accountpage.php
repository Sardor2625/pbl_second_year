        ...
        <div class="row">
          ...
          <div class="col-lg-6">
            <div class="p-5">
              ...
              <hr>
              <div class="text-center">
                <a class="small" href="<?php echo base_url(); ?>indexcontrol/forgotpassuser">Forgot Password?</a>
              </div>
              <div class="text-center">
                <a class="small" href="<?php echo base_url(); ?>usercontrol/login">Already have an account? Login!</a>
              </div>
            </div>
          </div>
           <div class="col-lg-3 d-none d-lg-block"></div>
