          ...
          <h1 style="margin-left: 72px;" class="h4 text-gray-900 mb-2 text-center">Xavfsiz hisob</h1> 
               ...
               <?php echo form_open('indexcontrol/create_newpass/'.$id->u_id.'', $attributes); ?>
                ...
                <div style="margin-left: 45px;" class="form-group row">
                  ...
                  <span style="margin-left: 3%;" id="eyeo" class="fa fa-eye"></span>
                   <input id="newpass" type="password" class="form-control <?= (form_error('newpass') == "" ? '':'is-invalid') ?>"  name="newpass" placeholder="Yangi parolni kiriting" >
                  <div class="text-danger text-center"><?php echo form_error('newpass'); ?></div>
                  <?php echo form_label('Confirm Password') ?>
                   <input type="password" class="form-control <?= (form_error('cpass') == "" ? '':'is-invalid') ?>"  name="cpass" placeholder="Parolni tasdiqlang" >
