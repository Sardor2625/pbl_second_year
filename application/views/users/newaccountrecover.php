           ...
           <div style="margin-left: 280px;" class="col-sm-6">
              ...
              <h2 class="h3 mb-2 text-gray-800">Hisobni tiklash</h2>            
              <h5>Davom etishdan oldin hisobingizni tiklashni yarating</h5>
               <?php
               ...
               <?php echo form_open('indexcontrol/newaccountquestion', $attributes); ?>
                ...
                <div class="form-group">
                  ...
                  <span style="margin-left: 3%;" id="eyen" class="fa fa-eye"></span>
                    <input id="newsecretans" type="password" class="form-control form-control-user <?= (form_error('secanswer') == "" ? '':'is-invalid') ?>"  name="secanswer" placeholder="Javobni kiriting" >
                  <div class="text-danger text-center"><?php echo form_error('secanswer'); ?></div>
                </div>
                <div class="form-group">
                  <?php echo form_label('Confirm Secret Answer') ?>
                    <input type="password" class="form-control form-control-user <?= (form_error('cosecanswer') == "" ? '':'is-invalid') ?>"  name="cosecanswer" placeholder="Javobni tasdiqlash" >
