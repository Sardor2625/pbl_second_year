           ...
           <?php endif; ?>
               ...
               <?php echo form_open('usercontrol/accountlogin', $attributes); ?>
                ...
                <div class="form-group ">
                  ...
                  <input type="text" class="form-control <?= (form_error('user1') == "" ? '':'is-invalid') ?> "  name="userlogin" placeholder="Foydalanuvchi nomi" value="<?php echo set_value('user1') ?>">
                  <div class="text-danger text-center"><?php echo form_error('user1'); ?></div>
                </div>
                <div class="form-group">
                   <?php echo form_label('Password') ?>
                    <input type="password" class="form-control <?= (form_error('pass1') == "" ? '':'is-invalid') ?>" name="passlogin" placeholder="Parol" value="<?php echo set_value('pass1') ?>">
