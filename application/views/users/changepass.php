    ...
    <?php if($this->session->flashdata('pass_updated')): ?>
          ...
          <?php echo "<div class='alert alert-success alert-dismissible text-center'>
           ...
           <?php endif; ?>
              ...
              <h2 class="h3 mb-2 text-gray-800">Parolni o'zgartirish</h2>            
               ...
               <?php echo form_open('indexcontrol/changepassupdate', $attributes); ?>
                ...
                <div class="form-group">
                  ...
                  <input id="oldpassword" type="password" class="form-control <?= (form_error('oldpass') == "" ? '':'is-invalid') ?>"  name="oldpass" placeholder="Eski parolni kiriting">
                ...
                <div class="form-group">
                  ...
                  <span style="margin-left: 2%;" id="eyen" class="fa fa-eye"></span>
                    <input id="newpassword" type="password" class="form-control  <?= (form_error('pass') == "" ? '':'is-invalid') ?>" name="pass" placeholder="Yangi parolni kiriting" >
                    <div class="text-danger text-center"><?php echo form_error('pass'); ?></div>
                </div>
                 <div class="form-group">
                  <?php echo form_label('Confirm Password'); ?>
           
                    <input id="cpassword" type="password" class="form-control <?= (form_error('cpass') == "" ? '':'is-invalid') ?>" name="cpass" placeholder="Parolni tasdiqlang" >
